...
--allow-run-as-root 
{hosts} 
python /benchmarks/pytorch_synthetic_benchmark.py --model {model} --batch-size 64""".replace('\n', '')

# Running on single node without mpi
cmd_local="""python /benchmarks/scripts/tf_cnn_benchmarks/tf_cnn_benchmarks.py --model {model} --batch-size 64""".replace('\n', '')
